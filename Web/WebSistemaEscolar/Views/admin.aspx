<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="WebSistemaEscolar.Views.admin" %>
  ...
  <md-sidenav class="site-sidenav md-sidenav-left md-whiteframe-z2"
    ...
    <header class="nav-header">
       <a ng-href="#/" class="docs-logo">
           <img src="../Images/SistemLogo.png"/>
           <!--h1 class="docs-logotype md-heading">Sistem</h1-->
        </a>
         <br />
         <br />
    </header>
